      ...
      <div class="mainCon">
        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="spuSaleAttr of spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd
                  ...
                  @click="changeIsCheck(spuSaleAttrValue,spuSaleAttr.spuSaleAttrValueList)"
                >
            ...
            <div class="cartWrap">
              <div class="controls">
                <input autocomplete="off" class="itxt" v-model="skuNum" @keyup="limitingInput"/>
                <a href="javascript:" class="plus" @click="skuNum++">+</a>
                <a href="javascript:" class="mins" @click="skuNum>1?skuNum--:skuNum = 1">-</a>
              </div>
              <div class="add">
                <a href="javascript:" @click="handler">加入购物车</a>
              </div>
            </div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    getData() {
      this.$store.dispatch("detail/getDataToDetail", this.$route.params.skuid);
    },
    // 排他思想class变换，获取到list跟里面的item
    changeIsCheck(value,valueList){
      valueList.forEach(element => {
        element.isChecked = 0
      });
      value.isChecked = 1
    },
    // 限制用户输入的只能是正整数数字（不大于200）
    limitingInput(e){
